...
public class TaskQueueDaemonThread {
    ...
    public void putTask(long time, Runnable task) {
        ...
        logger.info("<<<<<<<<putTask--delayQueueTask:" + delayQueueTask.size());
    }
    ...
    public boolean endTask(Task<Runnable> task) {
        boolean remove = delayQueueTask.remove(task);
        logger.info(">>>>>>>>endTask--delayQueueTask:" + delayQueueTask.size() + ",remove:" + remove);
        return remove;
    }
    ...
    public DelayQueue<Task> getDelayQueueTask() {
